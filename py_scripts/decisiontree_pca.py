...
print("\nHello!\n\nThis Decision Tree regression model predicts superconductor critical temperatures. The first model uses default parameters")
...
#make predictions
pca_preds = dtr.predict(X_test_pca)
