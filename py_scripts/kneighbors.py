...
print("\nHello!\n\nThis KNeighbors regression model predicts superconductor critical temperatures. The first model uses default parameters")
...
########################################################################
## KNeighbors model with PCA dimensionality reduction
########################################################################
...
#make predictions
pca_preds = knr.predict(X_test_pca)
