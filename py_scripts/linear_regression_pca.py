...
print("\nHello!\n\nThis Linear regression model predicts superconductor critical temperatures. The first model uses default parameters")
...
########################################################################
## Linear Regression model with PCA dimensionality reduction
########################################################################
